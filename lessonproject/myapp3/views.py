...
from django.shortcuts import render, get_object_or_404  # функция render упрощает объем кода
...
"""    
В отличиe от двух первых представлений, третье возвращает JSON объект.
